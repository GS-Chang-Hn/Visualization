...
def main(args):
    ...
    if args.savefig:
        fig = plt.gcf()
        fig.savefig("ff.png", dpi=3600, transparent=True, bbox_inches="tight", pad_inches=0)
        canvas = FigureCanvasAgg(fig)
        canvas.draw()
        img = Image.fromarray(np.array(canvas.renderer.buffer_rgba()))
        img.save(r'D:\changzb\sapace\LZU_WORK_SPACE\torch-cam-main\scripts\晚疫病1.png')  # 写入、保存
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--img",
        type=str,
        # default="https://image.cnhnb.com/image/jpg/head/2020/06/26/4256eead592a4f21a166bcc896c20dee.jpg",
        default='D:\changzb\sapace\LZU_WORK_SPACE\\torch-cam-main\scripts\\晚疫病.png',
    ...
    parser.add_argument("--savefig", type=str, default=True, help="Path to save figure")
